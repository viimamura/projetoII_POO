...
public class ConvertWindow extends JFrame {
	...
	private static String statusIdioma;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
			        ...
			        statusIdioma = loc.getLanguage();//verifica o status atual e a var recebe o mesmo
	...
	public ConvertWindow() {
		if(statusIdioma == en) {//verifica se o idioma atual é em inglês
			setResizable(false);
			setTitle("ICONVERT - Convert of units");
			...
			JLabel lblNewLabel = new JLabel("Hi! Welcome to ICONVERT");
			...
			JLabel lblNewLabel_1 = new JLabel("Input values");
			...
			JLabel lblNewLabel_1_1 = new JLabel("Output values");
		...
		}if(statusIdioma == pt) {//verifica se o idioma atual é em português
			setResizable(false);
